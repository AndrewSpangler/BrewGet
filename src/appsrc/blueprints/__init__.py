...
def get_blueprints() -> Generator:
    ...
    # Other blueprints depend on user models for auth reasons
    from .user import blueprint as user_blueprint
    yield user_blueprint # Init first
    
    # Load all other blueprints, order matters for plugin dependencies
    from .appstore import blueprint as appstore_blueprint
    # from .docu import blueprint as docu_blueprint
